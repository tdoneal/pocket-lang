...
func (d *Debug) initialize() {
	...
	ntl[NTR_FOR_IN_ITERVAR] = "ITERVAR"
	ntl[NTR_FOR_IN_ITEROVER] = "ITEROVER"
	ntl[NT_FOR_CLASSIC] = "FORCLASSIC"
	ntl[NTR_FOR_INITIALIZER] = "INITIALIZER"
	ntl[NTR_FOR_PROGRESSOR] = "PROGRESSOR"
	ntl[NT_WHILE] = "WHILE"
	...
	ntl[NTR_OBJFIELD_ACCESSOR_NAME] = "OFANAME"
	ntl[NT_COLLECTION_INDEXOR] = "COLLINDEXOR"
	ntl[NT_CLASSTABLE] = "CLASSTABLE"
	ntl[NTR_CLASSTABLE] = "CLASSTABLE"
	ntl[NT_REFLECTTYPE] = "REFLECTTYPE"
	ntl[NTR_REFLECTTYPE_CLASSDEF] = "REFLCLASS"
